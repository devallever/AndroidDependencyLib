...
public class TabLayout extends HorizontalScrollView {
    ...
    public void needDrawSelectedIndicator(boolean need) {
        mTabStrip.needDrawSelectedIndicator(need);
    }
    ...
    private class SlidingTabStrip extends LinearLayout {
        private boolean mNeedDrawSelectedIndicator = true;
        ...
        void needDrawSelectedIndicator(boolean need) {
            mNeedDrawSelectedIndicator = need;
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (mNeedDrawSelectedIndicator) {
                if (mSelectedIndicatorWidth == 0 || mIndicatorRight - mIndicatorLeft == mSelectedIndicatorWidth) {
                    ...
                    if (mIndicatorRight - mIndicatorLeft < mSelectedIndicatorWidth) {
                        int offset = (mSelectedIndicatorWidth - (mIndicatorRight - mIndicatorLeft)) >> 1;
                        ...
                        int offset = ((mIndicatorRight - mIndicatorLeft) - mSelectedIndicatorWidth) >> 1;
                        canvas.drawRect(mIndicatorLeft + offset, getHeight() - mSelectedIndicatorHeight,
                                mIndicatorRight - offset, getHeight(), mSelectedIndicatorPaint);
                    }
                }
